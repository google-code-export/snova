...
public class C4ClientConfiguration
{
	protected static Logger	                 logger	     = LoggerFactory
	                                                             .getLogger(C4ClientConfiguration.class);
	private static C4ClientConfiguration	instance	= null;
	...
	static
	{
		try
		{
			JAXBContext context = JAXBContext
			        .newInstance(C4ClientConfiguration.class);
			Unmarshaller unmarshaller = context.createUnmarshaller();
			instance = (C4ClientConfiguration) unmarshaller
			        .unmarshal(C4ClientConfiguration.class
			                .getResource("/c4-client.xml"));
			instance.init();
		}
		catch (Exception e)
		{
   ...
   private int	httpRequestTimeout = 30000;
	...
	private int	sessionIdleTimeout = 50000;
	@XmlElement(name = "SessionIdleTimeout")
	...
	public void init() throws Exception
	{
		...
		if (null != serverAuths)
		{
			...
			{
				C4ServerAuth auth = serverAuths.get(i);
	...
	public void save() throws Exception
	{
		try
		{
			...
			URL url = C4ClientConfiguration.class.getResource("/c4-client.xml");
