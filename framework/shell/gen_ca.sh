...
if $cygwin; then
  ...
  HYK_PROXY_HOME=`cygpath --path --$format "$SNOVA_HOME"`
fi

java -cp "$CLASSPATH" -DSNOVA_HOME="$SNOVA_HOME" org.snova.framework.util.SslCertificateHelper