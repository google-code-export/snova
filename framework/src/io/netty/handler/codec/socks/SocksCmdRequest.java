...
public final class SocksCmdRequest extends SocksRequest
{
	...
	public SocksCmdRequest(CmdType cmdType, AddressType addressType,
	        String host, int port)
	{
		...
		switch (addressType)
		{
			...
			case DOMAIN:
				...
				break;
			case IPv6:
				if (!NetworkHelper.isValidIpV6Address(host))
				{
					throw new IllegalArgumentException(host
	...
	public void encodeAsByteBuf(ChannelBuffer byteBuf)
	{
		...
		switch (addressType)
		{
			case IPv4:
			{
				byteBuf.writeBytes(NetworkHelper
				        .createByteArrayFromIpAddressString(host));
