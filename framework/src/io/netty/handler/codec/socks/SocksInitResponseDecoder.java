...
/**
 * Decodes {@link ByteBuf}s into {@link SocksInitResponse}. Before returning
 * SocksResponse decoder removes itself from pipeline.
 */
public class SocksInitResponseDecoder extends
        ReplayingDecoder<SocksInitResponseDecoder.State>
{
	        ...
	        ChannelBuffer byteBuf, State state) throws Exception
	{
		switch (state)
		{
			...
			{
				authScheme = SocksMessage.AuthScheme.fromByte(byteBuf
				        .readByte());
