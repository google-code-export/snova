...
/**
 * Decodes {@link ByteBuf}s into {@link SocksCmdRequest}. Before returning
 * SocksRequest decoder removes itself from pipeline.
 */
public class SocksCmdRequestDecoder extends
        ReplayingDecoder<SocksCmdRequestDecoder.State>
{
	...
	@Override
	public SocksRequest decode(ChannelHandlerContext ctx, Channel channel,
			...
			case READ_CMD_ADDRESS:
			{
				switch (addressType)
				{
					case IPv4:
					{
						...
						msg = new SocksCmdRequest(cmdType, addressType, host,
						        port);
						break;
					}
					case DOMAIN:
