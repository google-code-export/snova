...
public class AppIdDialog extends javax.swing.JDialog {
    ...
    public void startAddAppId( UICallback callback)
    {
         ...
         setAuthComponentStatus();
         setVisible(true);
    }

    public void startModifyAppId(GAEServerAuth auth, UICallback callback)
    {
         ...
         this.callback = callback;
         jRadioButton1.setSelected(auth.user != null && !auth.user.isEmpty() && !auth.user.equals(GAEConstants.ANONYMOUSE_NAME));
         setLocationByPlatform(true);
         setAuthComponentStatus();
         setVisible(true);
    }
    ...
    private void setAuthComponentStatus()
    {
